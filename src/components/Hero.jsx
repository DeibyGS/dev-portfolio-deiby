function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen bg-slate-950 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center"
    >
      {/* Avatar */}
      ...
      <p className="text-base md:text-lg text-slate-400 max-w-xl mx-auto mb-8">
        Construyo aplicaciones web y móviles con stack moderno. Apasionado por la
        arquitectura limpia, las APIs robustas y las interfaces que tienen sentido.
      </p>

      {/* CTA */}
      <a
        href="#projects"
        className="bg-cyan-400 text-slate-950 font-semibold px-6 py-3 rounded-lg text-sm hover:bg-cyan-300 transition-colors duration-200 mb-8"
      >
        Ver proyectos
      </a>
